...
class empresasController{
    ...
    public function ver2(){
       ...
       require_once 'view/empresas/empresas.php';
    ...
    public function Index(){
       $pvd = new empresas();
       //$this->verificarSesion(); // Verificar si el usuario está autenticado  
      // $this->evitarCache();     // Evitar el almacenamiento en caché empresas empresasSerigraficos
   ...
   public function EditarProducto()
    ...
    private function procesarImagen($imagen)
    {
        ...
        $directorio = 'assets/img/empresas/';
