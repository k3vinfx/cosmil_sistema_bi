...
class productosController{
    ...
    public function ver2(){
       ...
       require_once 'view/productos/productosSerigraficos.php';
    ...
    public function Index(){
       $pvd = new productos();
       //$this->verificarSesion(); // Verificar si el usuario está autenticado  
      // $this->evitarCache();     // Evitar el almacenamiento en caché productos productosSerigraficos
    ...
    public function Obtenerproductos()
    {
        try {
            ...
            $pvd = $this->model->Obtenerproductos($id);
